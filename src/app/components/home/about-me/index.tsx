          ...
          <div className="container">
            ...
            <div className="pt-10 xl:pt-16 flex gap-10 items-center justify-between">
              ...
              <div className="w-full lg:max-w-2xl flex-1">
                <p>
                  Hi, I’m Shanmuga Sundari, an Associate Software Engineer with a strong focus on testing and a creative passion for design. Testing is my profession — where I strive for quality, precision, and reliability — while designing fuels my creativity and innovation. I enjoy blending technical expertise with visual creativity to deliver meaningful and user-friendly digital experiences.
                </p>
                ...
                <div className="pt-8 xl:pt-14 flex flex-col sm:flex-row items-center gap-4">
                  ...
                  <div className="flex flex-wrap justify-center items-center gap-2.5">
                    {["Tamil", "English", "Malayalam"].map((lang) => (
                      <p
                        key={lang}
